...
"""autogenerated by genpy from hospitalbot/Communication.msg. Do not edit."""
import sys
...
class Communication(genpy.Message):
  _md5sum = "bc0cceee922687683f945debbb6595bd"
  _type = "hospitalbot/Communication"
...
string metadata
string status"""
  __slots__ = ['source','target','type','metadata','status']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       source,target,type,metadata,status
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.metadata = str[start:end].decode('utf-8')
      else:
